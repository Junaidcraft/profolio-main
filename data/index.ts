...
export const testimonials = [
  {
    quote:
      '" Junaid is also very proessional and reliable. He was always responsive to my communication, and he met all of his deadlines. He was also very open to feedback, and he was always willing to make changes to the project until I was completely satisfied. Overall, I am extremely happy with the work that Junaid did for me. He is a truly exceptional developer, and I highly recommend him to anyone looking for a skilled and reliable frontend and backend developer. To put it in a more casual way, Junaid is the man! He knows his stuff, he\'s easy to work with, and he gets the job done. If you need a frontend or backend developer, I highly recommend him "',
